...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_version_external_secrets"></a> [chart\_version\_external\_secrets](#input\_chart\_version\_external\_secrets) | Chart version | `string` | `null` | no |
...
| <a name="input_helm_release_name"></a> [helm\_release\_name](#input\_helm\_release\_name) | Release name | `string` | `"external-secrets"` | no |
